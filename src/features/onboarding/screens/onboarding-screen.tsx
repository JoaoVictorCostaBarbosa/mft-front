...
import { goalOptions, savePendingGoal } from "@/features/profile";
import { routes } from "@/lib/routes";
import { cn } from "@/lib/utils";

export function OnboardingScreen() {
  const [selectedGoal, setSelectedGoal] = React.useState<UserGoal>("muscle");
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col bg-background">
      <div className="flex flex-1 flex-col overflow-y-auto">
        ...
        <div className="flex flex-col gap-3 px-6 pb-10 pt-6">
          <Link
            href={routes.signUp}
            onClick={() => savePendingGoal(selectedGoal)}
